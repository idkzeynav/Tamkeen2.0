...
const handleGoogleSignup = () => {
  window.location.href = `${server}/user/auth/google`; // Add '/user' segment
};
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl p-8 relative overflow-hidden">
          ...
          <div className="mb-8">
            <button
              ...
              className="w-full py-3 px-4 bg-white border border-gray-300 rounded-lg flex items-center justify-center space-x-2
          ...
          <div className="relative flex py-3 items-center">
            ...
            <span className="flex-shrink mx-4 text-gray-600">or sign up with email</span>
            <div className="flex-grow border-t border-gray-300"></div>
          </div>

          <animated.form style={formAnimation} onSubmit={handleSubmit} className="space-y-6 mt-6">
            {/* Name Input */}
