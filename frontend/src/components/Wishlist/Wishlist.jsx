...
//overflow-y-scroll 800px:w-[25%] bg-[#d8c4b8] flex flex-col
...
//             <h4 className="font-[600] pt-3 800px:pt-[3px]
//text-[17px] text-[#a67d6d] font-Roboto">
//               Rs{totalPrice}
//             </h4>
//           </div>
...
`${backend_url}${data.images[0]}` : '/path-to-default-image.jpg'}
          ...
          <div className="pl-[15px] text-[#5a4336]">
            ...
            <h4 className="font-[600] pt-3 800px:pt-[3px] text-[17px]
